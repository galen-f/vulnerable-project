package com.platform.audit.core;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main DescriptorRepositoryInternal.custom_function.CacheLoaderHelper ConfigRepositoryUtil.bool.AuditProviderImpl");
				System.exit(1);
			}
