package com.base.event.support;

import com.internal.platform.support.*;

// Test harness entry point for the event support package
public class Main {
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main PayloadControllerBase.custom_function.SessionBuilder ProfileServiceImpl.bool.ScheduleAggregatorBase");
				System.exit(1);
			}
			...
			// No arguments: run all batch groups in sequence
			runBatch1();
			runBatch2();
			runBatch3();
			runBatch4();
