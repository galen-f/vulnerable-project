package com.shared.profile.manager;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main DispatcherServiceCore.custom_function.DispatcherValidatorCore RegistryRepositoryCore.bool.AccountRouterImpl");
				System.exit(1);
			}
