package com.services.audit.core;

import com.internal.platform.support.*;

// Test runner for the audit core package
public class Main {
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ReportProviderHelper.custom_function.ProfileProviderUtil SessionFactoryImpl.bool.AuditValidatorV2");
				System.exit(1);
			}
