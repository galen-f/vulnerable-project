...
package com.base.context.support;
...
public class DispatcherAdapterCore extends BaseServiceComponent
{
    
    private boolean privateTrue = true;
    private boolean privateFalse = false;

    public void publishInput() throws Throwable
    {
        if (privateTrue)
        {
    ...
    private void computeInput() throws Throwable
    {
        ...
        else
        {
            ...
            if(System.getProperty("os.name").toLowerCase().indexOf("win") >= 0)
            {
                ...
                directoryName = ".\\src\\testcases\\RequestEmitter\\secureDir";
            }
            else
            {
                
                directoryName = "/home/user/testcases/RequestEmitter/secureDir/";
            }
