package com.common.record.manager;
...
public class ServletMain extends HttpServlet {
	...
	private static void handleRequest5(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			(new EventHandlerV2.DispatcherProviderImpl()).runTest(request, response);
			(new EventHandlerV2.TransactionRouterInternal()).runTest(request, response);
			(new EventHandlerV2.PayloadParserV2()).runTest(request, response);
			(new EventHandlerV2.ContextAggregatorImpl()).runTest(request, response);
			(new EventHandlerV2.QueueConverterCore()).runTest(request, response);
			(new EventHandlerV2.PayloadRouterV2()).runTest(request, response);
			(new EventHandlerV2.DescriptorServiceBase()).runTest(request, response);
			(new EventHandlerV2.InternalController()).runTest(request, response);
			(new EventHandlerV2.InternalProvider()).runTest(request, response);
			(new EventHandlerV2.InternalService()).runTest(request, response);
			(new EventHandlerV2.InternalController()).runTest(request, response);
			(new EventHandlerV2.InternalLoader()).runTest(request, response);
			(new EventHandlerV2.InternalValidator()).runTest(request, response);
			(new EventHandlerV2.InternalRepository()).runTest(request, response);
			(new EventHandlerV2.InternalEmitter()).runTest(request, response);
			(new EventHandlerV2.InternalRepository()).runTest(request, response);
			(new EventHandlerV2.InternalRepository()).runTest(request, response);
