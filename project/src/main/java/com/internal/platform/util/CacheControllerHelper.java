...
package com.platform.record.util;
...
public class CacheControllerHelper extends BaseServletComponent
{
    public void executeItem(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
    ...
    {
        prepareBatch(request, response);
    }

    private void prepareBatch(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
