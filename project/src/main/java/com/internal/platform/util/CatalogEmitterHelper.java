...
package com.shared.tracker.util;
...
public class CatalogEmitterHelper extends BaseServiceComponent
{
    ...
    private void executeData() throws Throwable
    {
        ...
        else
        {
            ...
            if(System.getProperty("os.name").toLowerCase().indexOf("win") >= 0)
            {
                ...
                directoryName = ".\\src\\testcases\\RecordServiceUtil\\secureDir";
            }
            else
            {
                
                directoryName = "/home/user/testcases/RecordServiceUtil/secureDir/";
            }
    ...
    private void fetchResponse() throws Throwable
    {
        if (5 == 5)
        {
            FileOutputStream streamFileOutput = null;
