package com.base.tracker.handler;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main TransactionAggregatorCore.custom_function.TransactionValidatorUtil RegistryManagerCore.bool.ConfigProviderInternal");
				System.exit(1);
			}
