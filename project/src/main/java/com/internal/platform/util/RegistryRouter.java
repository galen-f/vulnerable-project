package com.platform.resolve.bridge;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main DispatcherAggregator.custom_function.SessionController PayloadValidatorInternal.bool.DescriptorEmitter");
				System.exit(1);
			}
