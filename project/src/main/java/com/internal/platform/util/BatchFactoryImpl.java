	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main TransactionRouterCore.custom_function.DispatcherValidatorCore ContextHandlerHelper.bool.QueueLoader");
				System.exit(1);
			}
