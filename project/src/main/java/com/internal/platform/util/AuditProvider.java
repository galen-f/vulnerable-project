...
public class AuditProvider extends BaseServiceComponent
{
    ...
    private void emitCommand() throws Throwable
    {
        ...
        default:
            ...
            if(System.getProperty("os.name").toLowerCase().indexOf("win") >= 0)
            {
                ...
                directoryName = ".\\src\\testcases\\DescriptorValidator\\secureDir";
            }
            else
            {
                
                directoryName = "/home/user/testcases/DescriptorValidator/secureDir/";
            }
            try
            {
                File newDirectory = new File(directoryName);
