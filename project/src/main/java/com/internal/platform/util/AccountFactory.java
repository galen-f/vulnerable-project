package com.internal.dispatch.handler;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main DescriptorParserCore.custom_function.RequestLoaderHelper ResponseParserCore.bool.EventServiceBase");
				System.exit(1);
			}
...
private static void runBatch5() {
			...
			(new CacheParserHelper.RecordManagerV2()).runTest("RecordManagerV2");
