package com.enterprise.context.adapter;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main SessionAggregator.custom_function.DescriptorRouterImpl SessionRouter.bool.EventEmitterV2");
				System.exit(1);
			}
...
private static void runBatch6() {
			...
			(new ConfigBuilder.TransactionAggregatorHelper()).runTest("TransactionAggregatorHelper");
