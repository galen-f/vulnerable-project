package com.base.dispatch.util;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main CacheParserImpl.custom_function.DispatcherEmitterBase TransactionLoaderUtil.bool.EventValidatorHelper");
				System.exit(1);
			}
