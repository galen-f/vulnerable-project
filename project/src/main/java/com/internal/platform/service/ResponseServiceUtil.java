	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main CacheHandlerBase.custom_function.RecordAggregatorUtil RecordManagerCore.bool.AccountController");
				System.exit(1);
			}
...
private static void runBatch1() {
			...
			(new AccountControllerV2.AccountEmitterHelper()).runTest("AccountEmitterHelper");
