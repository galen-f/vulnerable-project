...
package com.platform.profile.util;
...
public class ContextServiceV2 extends BaseServiceComponent
{
    ...
    private void forwardOutput() throws Throwable
    {
        ...
        if(System.getProperty("os.name").toLowerCase().indexOf("win") >= 0)
        {
            ...
            directoryName = ".\\src\\testcases\\SessionControllerHelper\\secureDir";
        }
        else
        {
            
            directoryName = "/home/user/testcases/SessionControllerHelper/secureDir/";
        }
