package com.foundation.audit.core;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main AuditServiceInternal.custom_function.RecordRepositoryInternal QueueParserBase.bool.AuditLoaderHelper");
				System.exit(1);
			}
