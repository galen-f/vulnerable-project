...
package com.common.tracker.bridge;
...
public class ReportWorkerV2 extends BaseServiceComponent
{
    ...
    private void executeContext() throws Throwable
    {
        switch (8)
        {
        case 7:
    ...
    public void handleResult() throws Throwable
    {
        executeContext();
        loadOutput();
    }
