package com.core.dispatch.handler;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main PayloadFactoryInternal.custom_function.ScheduleManagerInternal EventFactoryUtil.bool.RegistryRouterUtil");
				System.exit(1);
			}
...
private static void runBatch6() {
			...
			(new TransactionHandlerHelper.QueueManagerHelper()).runTest("QueueManagerHelper");
