package com.core.catalog.manager;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main EventRepositoryCore.custom_function.DispatcherRouterUtil ContextProviderV2.bool.DispatcherLoaderV2");
				System.exit(1);
			}
