	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ScheduleFactoryCore.custom_function.RecordControllerInternal TransactionServiceBase.bool.ReportAggregatorUtil");
				System.exit(1);
			}
