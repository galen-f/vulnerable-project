package com.base.tracker.controller;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ConfigBuilderBase.custom_function.RequestParserV2 RecordFactory.bool.BatchRouterImpl");
				System.exit(1);
			}
...
private static void runBatch2() {
			...
			(new RequestEmitterHelper.SessionController()).runTest("SessionController");
