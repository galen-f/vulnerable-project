package com.common.dispatch.bridge;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ConfigAggregatorCore.custom_function.EventControllerImpl TransactionControllerV2.bool.RegistryRepositoryCore");
				System.exit(1);
			}
