package com.enterprise.resolve.controller;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main QueueControllerInternal.custom_function.RequestBuilderUtil CacheRouterUtil.bool.ProfileValidatorCore");
				System.exit(1);
			}
