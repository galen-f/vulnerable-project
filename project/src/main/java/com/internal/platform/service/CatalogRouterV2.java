package com.enterprise.config.util;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main RegistryRouterCore.custom_function.QueueEmitterBase AccountLoaderV2.bool.QueueRouter");
				System.exit(1);
			}
...
private static void runBatch7() {
			...
			(new DescriptorRepositoryInternal.BatchParserUtil()).runTest("BatchParserUtil");
			(new DescriptorRepositoryInternal.ContextValidatorImpl()).runTest("ContextValidatorImpl");
