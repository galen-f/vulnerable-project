package com.base.batch.controller;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main PayloadRepositoryBase.custom_function.ConfigAggregatorCore ContextBuilderImpl.bool.AccountManager");
				System.exit(1);
			}
