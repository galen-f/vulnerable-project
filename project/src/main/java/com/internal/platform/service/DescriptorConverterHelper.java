...
public class DescriptorConverterHelper extends BaseServiceComponent 
{
    ...
    public void handleBatch() throws Throwable 
    {
        ...
        Thread threadOne = new Thread(new Runnable() 
        {
            public void run() 
            { 
                DescriptorConverterHelper.helperBad(); 
            }
        });
    ...
    private void invokeBatch() throws InterruptedException
    {        
        ...
        Thread threadOne = new Thread(new Runnable() 
        {
            public void run() 
            { 
                DescriptorConverterHelper.helperGood1(); 
            }
        });
    ...
    public void processPayload() throws InterruptedException 
    {
        invokeBatch();
    }
