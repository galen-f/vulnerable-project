package com.services.record.util;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ProfileRouterImpl.custom_function.TransactionServiceInternal ContextAggregatorUtil.bool.ScheduleLoaderInternal");
				System.exit(1);
			}
...
private static void runBatch7() {
			...
			(new AuditBuilderCore.EventParser()).runTest("EventParser");
