package com.foundation.event.support;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ScheduleParserHelper.custom_function.ContextServiceInternal ConfigManagerCore.bool.DescriptorValidatorHelper");
				System.exit(1);
			}
