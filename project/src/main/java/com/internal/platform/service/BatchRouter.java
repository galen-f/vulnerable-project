package com.core.record.adapter;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ResponseRepositoryCore.custom_function.ReportConverterV2 PayloadFactoryCore.bool.RegistryEmitterHelper");
				System.exit(1);
			}
