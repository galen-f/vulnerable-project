package com.infra.registry.impl;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main AuditManagerImpl.custom_function.QueueManager ReportProvider.bool.RequestEmitterUtil");
				System.exit(1);
			}
