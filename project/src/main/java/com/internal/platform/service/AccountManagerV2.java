package com.enterprise.record.manager;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main CacheParserV2.custom_function.RequestManagerImpl ConfigAggregatorV2.bool.QueueServiceImpl");
				System.exit(1);
			}
...
private static void runBatch6() {
			...
			(new ScheduleHandlerHelper.RecordHandlerHelper()).runTest("RecordHandlerHelper");
			(new ScheduleHandlerHelper.QueueConverterBase()).runTest("QueueConverterBase");
