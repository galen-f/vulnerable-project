package com.internal.processor.bridge;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ContextManagerV2.custom_function.CacheServiceBase ScheduleEmitterInternal.bool.DescriptorControllerHelper");
				System.exit(1);
			}
