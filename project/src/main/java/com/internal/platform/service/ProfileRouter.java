package com.foundation.audit.controller;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main RequestFactoryCore.custom_function.QueueManagerV2 CacheValidatorInternal.bool.BatchValidatorV2");
				System.exit(1);
			}
...
private static void runBatch5() {
			...
			(new RegistryBuilderBase.QueueEmitterV2()).runTest("QueueEmitterV2");
