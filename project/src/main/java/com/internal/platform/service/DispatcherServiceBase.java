	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main DescriptorServiceInternal.custom_function.RequestAggregatorBase BatchControllerUtil.bool.ScheduleEmitterV2");
				System.exit(1);
			}
...
private static void runBatch8() {
			...
			(new QueueManagerInternal.BatchBuilderUtil()).runTest("BatchBuilderUtil");
