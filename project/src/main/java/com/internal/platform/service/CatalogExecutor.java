	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main BatchControllerV2.custom_function.ProfileRepositoryV2 QueueManagerInternal.bool.QueueAggregatorUtil");
				System.exit(1);
			}
