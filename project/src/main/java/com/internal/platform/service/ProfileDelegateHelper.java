package com.services.payload.util;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main SessionParserHelper.custom_function.ContextConverterHelper TransactionEmitterInternal.bool.QueueParserImpl");
				System.exit(1);
			}
