...
package com.base.profile.handler;
...
public class QueueService extends BaseServiceComponent
{
    ...
    private void applyTransaction() throws Throwable
    {
        if (privateFalse)
        {
    ...
    private void convertTask() throws Throwable
    {
        if (privateTrue)
        {
            FileInputStream fis = null;
    ...
    public void runResponse() throws Throwable
    {
        applyTransaction();
        convertTask();
    }
