package com.internal.tracker.adapter;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main RecordProviderInternal.custom_function.AccountServiceUtil RegistryRouter.bool.ContextAggregatorInternal");
				System.exit(1);
			}
