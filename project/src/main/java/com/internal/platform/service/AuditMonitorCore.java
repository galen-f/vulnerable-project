	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main BatchServiceBase.custom_function.EventRouterInternal RegistryServiceHelper.bool.QueueFactoryV2");
				System.exit(1);
			}
...
private static void runBatch3() {
			...
			(new ProfileLoaderBase.TransactionRepositoryUtil()).runTest("TransactionRepositoryUtil");
			(new ProfileLoaderBase.ProfileRepository()).runTest("ProfileRepository");
			(new ProfileLoaderBase.ReportControllerV2()).runTest("ReportControllerV2");
			(new ProfileLoaderBase.InternalEmitter()).runTest("InternalEmitter");
