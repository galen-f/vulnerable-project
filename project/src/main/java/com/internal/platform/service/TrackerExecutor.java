package com.foundation.record.service;
...
public class ServletMain extends HttpServlet {
	...
	private static void handleRequest8(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			(new RecordControllerCore.ConfigValidatorBase()).runTest(request, response);
			(new RecordControllerCore.AccountConverterInternal()).runTest(request, response);
			(new RecordControllerCore.SessionValidatorInternal()).runTest(request, response);
