package com.core.registry.adapter;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ContextLoaderUtil.custom_function.DispatcherConverterBase RecordRepositoryHelper.bool.EventFactoryCore");
				System.exit(1);
			}
...
private static void runBatch8() {
			...
			(new QueueControllerV2.BatchManagerHelper()).runTest("BatchManagerHelper");
			(new QueueControllerV2.BatchService()).runTest("BatchService");
			(new QueueControllerV2.DispatcherManagerHelper()).runTest("DispatcherManagerHelper");
