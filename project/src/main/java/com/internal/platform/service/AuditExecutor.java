package com.internal.config.manager;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ContextHandlerImpl.custom_function.ResponseBuilderInternal BatchConverterInternal.bool.ScheduleProviderV2");
				System.exit(1);
			}
