...
package com.enterprise.resolve.bridge;
...
public class BatchParserCore extends BaseServletComponent
{
    ...
    public void resolveOperation(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
