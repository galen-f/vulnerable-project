package com.platform.cache.handler;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main EventHandlerUtil.custom_function.SessionBuilderInternal QueueAggregatorImpl.bool.ResponseParserUtil");
				System.exit(1);
			}
...
private static void runBatch5() {
			...
			(new CacheProviderImpl.RequestAggregatorImpl()).runTest("RequestAggregatorImpl");
