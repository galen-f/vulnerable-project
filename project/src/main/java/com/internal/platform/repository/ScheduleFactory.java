package com.common.context.handler;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ProfileServiceBase.custom_function.ContextHandlerInternal CacheBuilderHelper.bool.PayloadHandlerCore");
				System.exit(1);
			}
