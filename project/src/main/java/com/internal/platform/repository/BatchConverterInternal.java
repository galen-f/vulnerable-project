package com.infra.payload.bridge;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main TransactionBuilderBase.custom_function.AuditServiceInternal RecordAggregatorUtil.bool.EventEmitterImpl");
				System.exit(1);
			}
...
private static void runBatch7() {
			...
			(new ContextEmitterImpl.RegistryManagerHelper()).runTest("RegistryManagerHelper");
			(new ContextEmitterImpl.RequestConverterHelper()).runTest("RequestConverterHelper");
