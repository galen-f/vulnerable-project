...
package com.enterprise.transaction.util;
...
public class DispatcherMonitorV2 extends BaseServiceComponent
{
    public void loadPayload() throws Throwable
    {
        if (5 == 5)
        {
    ...
    private void initializeOperation() throws Throwable
    {
        if (5 == 5)
        {
            FileInputStream fis = null;
