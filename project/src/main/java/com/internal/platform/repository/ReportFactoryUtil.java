...
package com.foundation.processor.util;
...
public class ReportFactoryUtil extends BaseServletComponent
{
    ...
    public void evaluateResult(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        try
        {
            ...
            IO.writeString("evaluateResult() - result requested: " + data +"\n");
        }
    ...
    private void fetchTransaction(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        String data;
        if (IO.staticReturnsTrueOrFalse())
        {
    ...
    {
        fetchTransaction(request, response);
    }
