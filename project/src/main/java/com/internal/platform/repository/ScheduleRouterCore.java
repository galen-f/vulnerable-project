...
package com.platform.context.service;
...
public class ScheduleRouterCore extends BaseServiceComponent
{
    public void runOutput() throws Throwable
    {
        ...
        try
        {
            ...
            (new ConfigEmitterInternal()).emitOperation(dataSerialized  );
        }
        catch (IOException exceptIO)
        {
