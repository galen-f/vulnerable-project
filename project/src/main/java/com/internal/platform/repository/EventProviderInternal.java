...
public class EventProviderInternal
{
    public void delegatePayload(byte[] dataSerialized , HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        ...
        try
        {
            ...
            try
            {
                ...
                IO.writeString("processRequest() - result requested: " + data +"\n");
            }
