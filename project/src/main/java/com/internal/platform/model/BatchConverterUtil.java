package com.internal.profile.service;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ReportFactory.custom_function.TransactionServiceImpl TransactionBuilderHelper.bool.ReportParserBase");
				System.exit(1);
			}
...
private static void runBatch5() {
			...
			(new ConfigRouterInternal.BatchProvider()).runTest("BatchProvider");
			(new ConfigRouterInternal.ContextAggregatorBase()).runTest("ContextAggregatorBase");
