package com.platform.processor.bridge;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main QueueEmitterV2.custom_function.ResponseHandlerBase SessionConverterBase.bool.ProfileValidatorV2");
				System.exit(1);
			}
