package com.base.profile.bridge;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main SessionAggregatorUtil.custom_function.ProfileEmitterBase RequestServiceHelper.bool.DispatcherBuilderBase");
				System.exit(1);
			}
...
private static void runBatch4() {
			...
			(new TransactionProvider.ReportBuilderV2()).runTest("ReportBuilderV2");
