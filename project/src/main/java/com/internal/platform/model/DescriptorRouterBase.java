package com.core.session.controller;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main CacheValidatorInternal.custom_function.RecordEmitterImpl AccountProviderImpl.bool.DescriptorConverterImpl");
				System.exit(1);
			}
