	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java testcasesupport.Main testcases.SessionAggregatorImpl.custom_function.DescriptorLoaderCore testcases.AccountManager.bool.CacheEmitterInternal");
				System.exit(1);
			}
