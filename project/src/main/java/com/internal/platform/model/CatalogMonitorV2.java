	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main CacheProviderBase.custom_function.PayloadHandlerCore EventServiceHelper.bool.ReportServiceHelper");
				System.exit(1);
			}
...
private static void runBatch4() {
			...
			(new EventProviderV2.AuditControllerCore()).runTest("AuditControllerCore");
