package com.enterprise.account.controller;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main AuditBuilderBase.custom_function.ScheduleRepositoryUtil ReportAggregatorUtil.bool.ProfileRepositoryUtil");
				System.exit(1);
			}
