package com.platform.transaction.util;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ScheduleRouterV2.custom_function.DescriptorFactoryHelper ConfigLoaderCore.bool.ScheduleAggregatorInternal");
				System.exit(1);
			}
...
private static void runBatch5() {
			...
			(new ConfigAggregator.EventBuilderUtil()).runTest("EventBuilderUtil");
			(new ConfigAggregator.ReportValidatorV2()).runTest("ReportValidatorV2");
