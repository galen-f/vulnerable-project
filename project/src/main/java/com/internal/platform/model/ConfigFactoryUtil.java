package com.services.audit.bridge;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ResponseConverterUtil.custom_function.SessionProviderImpl DescriptorFactory.bool.ProfileManagerHelper");
				System.exit(1);
			}
