	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main EventHandlerImpl.custom_function.EventFactoryV2 EventControllerUtil.bool.ReportServiceV2");
				System.exit(1);
			}
