package com.infra.resolve.util;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main DescriptorEmitterInternal.custom_function.CacheRouterUtil QueueFactoryUtil.bool.ConfigController");
				System.exit(1);
			}
