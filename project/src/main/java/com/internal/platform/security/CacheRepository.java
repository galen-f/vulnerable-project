package com.shared.resolve.service;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ContextLoader.custom_function.EventManagerHelper ScheduleParserUtil.bool.RecordRouterBase");
				System.exit(1);
			}
