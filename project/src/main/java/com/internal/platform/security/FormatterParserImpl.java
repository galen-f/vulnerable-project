package com.platform.profile.impl;
...
public class ServletMain extends HttpServlet {
	...
	private static void handleRequest5(HttpServletRequest request, HttpServletResponse response) {
		try {
			...
			(new DispatcherLoaderImpl.ReportRepositoryV2()).runTest(request, response);
			(new DispatcherLoaderImpl.AccountRepositoryV2()).runTest(request, response);
			(new DispatcherLoaderImpl.BatchParserV2()).runTest(request, response);
			(new DispatcherLoaderImpl.DispatcherManager()).runTest(request, response);
			(new DispatcherLoaderImpl.ResponseServiceHelper()).runTest(request, response);
			(new DispatcherLoaderImpl.AuditLoaderV2()).runTest(request, response);
			(new DispatcherLoaderImpl.EventParserBase()).runTest(request, response);
			(new DispatcherLoaderImpl.InternalBuilder()).runTest(request, response);
			(new DispatcherLoaderImpl.InternalProvider()).runTest(request, response);
			(new DispatcherLoaderImpl.InternalFactory()).runTest(request, response);
			(new DispatcherLoaderImpl.InternalRepository()).runTest(request, response);
			(new DispatcherLoaderImpl.InternalManager()).runTest(request, response);
			(new DispatcherLoaderImpl.InternalRouter()).runTest(request, response);
			(new DispatcherLoaderImpl.InternalHandler()).runTest(request, response);
			(new DispatcherLoaderImpl.InternalRepository()).runTest(request, response);
			(new DispatcherLoaderImpl.InternalService()).runTest(request, response);
			(new DispatcherLoaderImpl.InternalRouter()).runTest(request, response);
