package com.shared.payload.handler;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ContextRepository.custom_function.RegistryRepositoryHelper AccountManagerBase.bool.ResponseFactoryInternal");
				System.exit(1);
			}
