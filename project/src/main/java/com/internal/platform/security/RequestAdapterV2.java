package com.foundation.profile.handler;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main AuditHandlerCore.custom_function.AuditLoaderUtil AccountServiceImpl.bool.QueueFactory");
				System.exit(1);
			}
