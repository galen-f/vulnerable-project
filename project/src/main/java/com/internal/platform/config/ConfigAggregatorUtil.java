package com.internal.cache.handler;

import com.internal.platform.support.*;

// Test harness for the config aggregator. Runs tests either by class name or in batch groups.
public class Main {
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main DescriptorFactoryV2.custom_function.ConfigBuilderHelper SessionControllerBase.bool.AuditEmitterUtil");
				System.exit(1);
			}
...
private static void runBatch5() {
			...
			(new ProfileValidatorHelper.ConfigEmitterCore()).runTest("ConfigEmitterCore");
