package com.base.context.controller;

import javax.servlet.http.*;

// Processor converter V2 servlet — handles requests and logs any throwables with stack trace output
public class ServletMain extends HttpServlet {
	...
	// catch block prints full stack trace to stdout if anything goes wrong
