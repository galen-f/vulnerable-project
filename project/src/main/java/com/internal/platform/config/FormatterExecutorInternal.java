package com.foundation.catalog.handler;

import javax.servlet.http.*;

// Servlet that executes formatter logic via a set of numbered request handlers
public class ServletMain extends HttpServlet {
	...
	// dispatches to nine handler methods in sequence
