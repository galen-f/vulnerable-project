...
package com.shared.session.support;
...
// Provider V2 that encrypts request data — starts with DES at 56-bit, then upgrades to AES 128-bit
public class RequestProviderV2 extends BaseServiceComponent
{
    // uses DES with 56-bit key
