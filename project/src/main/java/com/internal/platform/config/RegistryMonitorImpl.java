package com.core.catalog.adapter;

import com.internal.platform.support.*;

// Registry monitor harness — supports running specific test classes or all batch groups
public class Main {
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main TransactionHandlerBase.custom_function.ProfileLoaderInternal AuditEmitterCore.bool.ScheduleEmitterV2");
				System.exit(1);
			}
