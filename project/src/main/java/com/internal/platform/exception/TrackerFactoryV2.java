	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java testcasesupport.Main testcases.ScheduleFactoryCore.custom_function.ResponseControllerBase testcases.ReportController.bool.ProfileRouterCore");
				System.exit(1);
			}
...
private static void runTestCWE2() {
			...
			(new testcases.RecordAggregatorHelper.RecordHandlerHelper()).runTest("RecordHandlerHelper");
