package com.enterprise.config.support;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main EventControllerV2.custom_function.AuditEmitterHelper ProfileEmitterCore.bool.SessionHandlerImpl");
				System.exit(1);
			}
