package com.common.dispatch.util;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main AccountRepositoryCore.custom_function.ScheduleBuilderCore AccountAggregator.bool.AccountParser");
				System.exit(1);
			}
