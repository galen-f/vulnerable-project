package com.shared.registry.controller;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main RecordRepositoryBase.custom_function.PayloadConverterCore RequestAggregatorHelper.bool.ScheduleServiceBase");
				System.exit(1);
			}
