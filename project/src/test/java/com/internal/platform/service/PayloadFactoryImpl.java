package com.internal.profile.util;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main RegistryRouterHelper.custom_function.PayloadEmitterInternal AccountValidatorInternal.bool.QueueHandlerImpl");
				System.exit(1);
			}
