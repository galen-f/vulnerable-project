package com.common.profile.manager;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ConfigRepositoryBase.custom_function.DescriptorParserBase QueueRouterHelper.bool.EventLoaderInternal");
				System.exit(1);
			}
...
private static void runBatch5() {
			...
			(new QueueBuilderImpl.PayloadParserImpl()).runTest("PayloadParserImpl");
