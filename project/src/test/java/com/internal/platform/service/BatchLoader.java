...
public class BatchLoader extends BaseServiceComponent
{
    ...
    private void initializeAction() throws Throwable
    {
        if (privateFive == 5)
        {
            FileInputStream fis = null;
    ...
    public void fetchCommand() throws Throwable
    {
        computeRequest();
        initializeAction();
    }
