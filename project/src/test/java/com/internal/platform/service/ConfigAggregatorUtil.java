package com.core.session.support;


import javax.servlet.http.*;

// Servlet dispatcher for the session support test suite
public class ServletMain extends HttpServlet {
	...
	// Fans out to each CWE handler in sequence
	...
	// TODO: populate handler stubs as test cases are ported
