package com.shared.tracker.controller;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main ResponseManagerCore.custom_function.ResponseProviderImpl RegistryManagerBase.bool.CacheManagerImpl");
				System.exit(1);
			}
