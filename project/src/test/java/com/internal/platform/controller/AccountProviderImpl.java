	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main DispatcherBuilder.custom_function.QueueBuilderInternal RequestLoaderBase.bool.DescriptorControllerImpl");
				System.exit(1);
			}
			...
			// TODO: register test cases as they are added to the suite
			runBatch1();
			runBatch2();
			runBatch3();
			runBatch4();
