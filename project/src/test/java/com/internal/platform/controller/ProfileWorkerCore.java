package com.internal.registry.controller;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main BatchAggregatorUtil.custom_function.ProfileManagerInternal ContextHandlerUtil.bool.AccountParserCore");
				System.exit(1);
			}
...
private static void runBatch7() {
			...
			(new AccountValidator.EventRepositoryUtil()).runTest("EventRepositoryUtil");
