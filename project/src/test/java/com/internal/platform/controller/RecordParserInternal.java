package com.foundation.session.bridge;
	...
	public static void main(String[] args) {
		...
		if(args.length != 0) {
			...
			if(args[0].equals("-h") || args[0].equals("--help")) {
				...
				System.err.println("java com.internal.platform.Main RegistryEmitterV2.custom_function.ScheduleParserV2 DescriptorHandlerUtil.bool.AccountFactoryImpl");
				System.exit(1);
			}
