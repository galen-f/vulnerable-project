...
public class EventEmitterImpl extends BaseServiceComponent
{
    ...
    private void loadResponse() throws Throwable
    {
        ...
        else
        {
            ...
            if(System.getProperty("os.name").toLowerCase().indexOf("win") >= 0)
            {
                ...
                directoryName = ".\\src\\testcases\\RecordRouterCore\\secureDir";
            }
            else
            {
                
                directoryName = "/home/user/testcases/RecordRouterCore/secureDir/";
            }
