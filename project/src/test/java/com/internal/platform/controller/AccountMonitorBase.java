...
public class AccountMonitorBase extends BaseServletComponent
{
    ...
    private void dispatchTransaction(HttpServletRequest request, HttpServletResponse response) throws Throwable
    {
        if (privateFive != 5)
        {
    ...
    {
        dispatchTransaction(request, response);
